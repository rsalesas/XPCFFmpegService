...
class FFmpegProgress: FFmpegOutputHandler {
    ...
    required init?(from: Data) {
        guard let matchRegEx = MatchRegularExpression(in: from, pattern: FFmpegProgress.RegExPattern, options: .anchorsMatchLines), matchRegEx.matches.count >= 1 else {
